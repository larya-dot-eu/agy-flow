...
```bash
TMP_DIR=$(mktemp -d /tmp/agy-flow-update-XXXXXX) && git clone --depth 1 https://github.com/larya-dot-eu/agy-flow.git $TMP_DIR && $TMP_DIR/install-skills.sh && rm -rf $TMP_DIR
```
